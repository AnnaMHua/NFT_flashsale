...
public class SeckillActivityController {
    ...
    public String activityList(Map<String, Object> resultMap) {
        try (Entry entry = SphU.entry("seckills")) {
            ...
            log.error("查询秒杀活动被限流" + ex.toString());
            return "wait";
        }
...
//        SeckillCommodity seckillCommodity = seckillCommodityDao.querySeckillCommodityById(seckillActivity.getCommodityId());
        ...
        if (!StringUtils.isEmpty(seckillCommodityInfo)) { log.info("redis缓存数据:" + seckillCommodityInfo); seckillCommodity = JSON.parseObject(seckillActivityInfo,
